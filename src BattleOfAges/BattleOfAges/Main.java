...
public class Main {
    public static void create() {
        ...
        static Age[] arrayOfAges = {Age1, Age2, Age3, Age4};
        ...
        static Turret[] arrayOfTurrets = {TypeOneTurret, TypeTwoTurret, TypeThreeTurret, TypeFourTurret};
        ...
        static Type1 type1 = new Type1();
        static Type2 type2 = new Type2();
        static Type3 type3 = new Type3();
    }
